    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                    ...
                    <h2 class="title text-center">{{ $categoryDetail->name }} Items</h2>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="/images/backend/products/medium/{{ $product->image }}" alt="image" class="imgProduct" />
                                            <br><br><br>
                                            <h2>{{ $product->price }}</h2>
                                             <p>{{ $product->product_name }} {{ $product->product_code }}</p>
                                            <a href="{{route('productDetails',$product->id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            
                                        </div>
                                        <img src="/user/images/home/sale.png" class="new itemHover" alt="" style="display: none;">
                                </div>
                                <div class="choose">
...
<script>
    $(document).ready( function () {
        ...
        $(".single-products").mouseenter(function(){
            
            $(this).find("img.new.itemHover").css("display","block");
            $(this).find(".imgProduct").css({'transition': 'transform 0.4s','transform': 'scale(1.04)'});
            $(this).css("background","#E9EDF8");
        }).mouseleave(function(){
            $(this).find("img.new.itemHover").css("display","none");
            $(this).css("background","#FFFFFF");
            $(this).find(".imgProduct").css({'transition': 'transform 0.4s','transform': 'scale(1)'});
        })
    });
</script>
